...
<html lang="pt">
  ...
  <div style="width: 300px; height: 80px; bottom: 10px; right: 5px; position: fixed;" id="alert">
      <div>
        <?php
          if(isset($_SESSION['erroAtividade'])):
        ?>
    ...
    <div style="width: 300px; height: 80px; bottom: 10px; right: 5px; position: fixed;" id="alert">
      <div>
        ...
        ?>
        <div style="margin-right: 0; position: absolute;" class="alert alert-danger" role="alert">
          O campo tipo deve possuir no máximo 50 caracteres.
        </div>
        <?php
    ...
    <div style="width: 300px; height: 80px; bottom: 10px; right: 5px; position: fixed;" id="alert">
      <div>
        <?php
          if(isset($_SESSION['erroAtvETipo'])):
        ?>
        <div style="margin-right: 0; position: absolute;" class="alert alert-danger" role="alert">
          O nome e o campo tipo devem possuir no máximo 50 caracteres.
        </div>
        <?php
          unset($_SESSION['erroAtvETipo']);
          endif;
    ...
    <div id="meusDados" class="container">
        <div class="row">
            <div class="col">
                <form action="..\controller\C_adicionarAtividade.php" method="POST">
                    <div class="form-group input">
                      <input type="text" class="form-control" placeholder="Atividade" name="nomeAtividade" required>
                    </div>
                    <div class="form-group input">
                    ...
                    <div class="form-group input">
                        <input type="number" class="form-control" placeholder="Nota" name="nota">
                    </div>
